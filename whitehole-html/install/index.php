...
<title>배추빌더 lite 설치 (1/3) - 라이센스(License)</title>
<style type="text/css">
<!--
.body {
    font-family: 굴림;
...
<body background="img/all_bg.gif" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
  ...
  <table width="587" border="0" cellspacing="0" cellpadding="0" align=center>
    ...
    <tr> 
      <td width="3" style="background:url(img/box_left.gif);" width="3" height="340"></td>
	  ...
	  <table width="581" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            <td>배추빌더 Lite 와 그누보드4가 함께 설치됩니다. 라이센스(License) 내용을 반드시 확인하십시오.</td>
          </tr>
          <tr> 
            <td height="10"></td>
          </tr>
...
<?=implode("", file("../LICENSE"));?>
      ...
      <td width="3" style="background:url(img/box_right.gif)" width="3" height="340"></td>
    </tr>
    <tr> 
