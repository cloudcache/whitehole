...
//exit;
if ($chk_count != 0) {
	alert_msg("Already Registered Secondary Storage!!!");
	exit;
}
...
<html>
<head>
	<title>Whitehole - Add Secondary Storage</title>
</head>
<body>
<form name=add_new_node method=post action=proc-add_secondary_storage.php>
