...
<html>
<head>
	<title>Whitehole - Add VM from ISO</title>
<!--	<link rel="stylesheet" href="style01.css" type="text/css"> -->
</head>
<body>
<form name=add_new_vm method=post action=proc-add_vm_iso.php>
<table align=center width=500 border=1 cellspacing=0 cellpadding=5>
	<tr align=center>
		<td align=center bgcolor=99CCFF><b>Hostname
		<td align=center><input type=text name=hostname size=35 maxlength=20><br><font color=red>(Optional, and Don't use underbar)</font>
	<tr align=center>
