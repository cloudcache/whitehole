...
<? if ($is_etc) { ?>
        ...
        <tr> 
            <td> 
                ...
                <tr> 
                    ...
                    <td>
                        의견 <input type='text' name='pc_idea' size=40 class=input required itemname='의견' maxlength="100"> &nbsp;
    ...
    <? for ($i=0; $i<count($list2); $i++) { ?>
        ...
        <tr> 
            ...
            <td width="550" height="25" colspan="3" bgcolor="#FAFAFA"><?=get_text($list2[$i][idea])?></td>
        </tr>
        </table>
    <? } ?>
