...
$order = "";
switch ($item) {
    case "date" : $order = "wr_datetime"; break;
    case "subject" : $order = "wr_subject desc"; break;
}

$sql = "select wr_id, wr_num from {$write_table} where wr_is_comment = 0 and wr_reply = '' order by $order";
$qry = sql_query($sql);
