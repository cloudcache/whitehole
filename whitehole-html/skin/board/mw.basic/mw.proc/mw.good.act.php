    ...
    else
    {
        ...
        { 
            ...
            if ($mw_basic[cf_good_point])
                insert_point($write[mb_id], $mw_basic[cf_good_point], "추천 점수를 받았습니다.", $bo_table, $wr_id, $member[mb_id].'@good');
            if ($mw_basic[cf_good_re_point])
                insert_point($member[mb_id], $mw_basic[cf_good_re_point], "추천 했습니다.", $bo_table, $wr_id, $member[mb_id].'@good_re');
        }
        else
        {
            $status = "비추천";
            if ($mw_basic[cf_nogood_point])
                insert_point($write[mb_id], $mw_basic[cf_nogood_point], "비추천 점수를 받았습니다.", $bo_table, $wr_id, $member[mb_id].'@nogood');
            if ($mw_basic[cf_nogood_re_point])
                insert_point($member[mb_id], $mw_basic[cf_nogood_re_point], "비추천 했습니다.", $bo_table, $wr_id, $member[mb_id].'@nogood_re');
